...
export const CASE_TRANSITIONS: Record<CaseStatus, CaseStatus[]> = {
  ...
  COUNSELLOR_ACCEPTED: [CaseStatus.SLOT_PROPOSED],
  SLOT_PROPOSED: [CaseStatus.SLOT_CONFIRMED, CaseStatus.COUNSELLOR_ACCEPTED],
  SLOT_CONFIRMED: [CaseStatus.AGREEMENT_PENDING],
